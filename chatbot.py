...
def run_step(sess, model, encoder_inputs, decoder_inputs, decoder_masks, bucket_id, forward_only):
    ...
    训练模式forward_only = false"""

    # print(encoder_inputs) array
    # print( decoder_inputs) array
    # print(decoder_masks) array
    # print( bucket_id) 1
    # print( forward_only)  False
...
def train():
    ...
    # 在训练模式中，我们需要创建后向路径，因此forward_only为False
